...
- **Short zones where throttle is never full**: If a corner zone starts after the driver already lifted (from a previous corner), the throttle-based entry falls back to speed-peak.
