 ...
 * runner can discover and execute it. The Python script uses the
 * same [PASS]/[FAIL] protocol as JS tests.
 */
...
const script = path.join(ROOT, 'dev', 'scripts', 'test_live_after_lap_spoken_summary.py');
