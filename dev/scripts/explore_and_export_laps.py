...
Usage:
    ...
    python3 scripts/explore_and_export_laps.py dev/sessions/session_*.parquet

    # Export specific laps (e.g., laps 3 and 5)
    python3 scripts/explore_and_export_laps.py dev/sessions/session_*.parquet --export 3,5

    # Export fastest 3 complete laps
    python3 scripts/explore_and_export_laps.py dev/sessions/session_*.parquet --fastest 3

    # Export all complete laps
    python3 scripts/explore_and_export_laps.py dev/sessions/session_*.parquet --export-all
"""
...
Examples:
  ...
  python3 scripts/explore_and_export_laps.py dev/sessions/session_*.parquet --export-all
    ...
    if args.export:
        ...
        print("\nExample: python3 scripts/explore_and_export_laps.py dev/sessions/session_*.parquet --fastest 3")
