...
const SCRIPT = path.join(ROOT, 'scripts/compute_boundaries.js');
...
async function runTests() {
  ...
  {
    const cpScript = path.join(ROOT, 'scripts/export_center_path.js');
    const wpScript = path.join(ROOT, 'scripts/export_width_profile.js');
