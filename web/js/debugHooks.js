...
export function installDebugHooks(deps) {
  ...
  window.__setFeatureFlag = (name, value) => {
    ...
    if (name === 'mapWalkingSkeleton' || name === 'mapTrackOutline' || name === 'mapHeatmapSingleLap' || name === 'mapSAlignment' || name === 'mapDualRibbon' || name === 'mapZoomPan' || name === 'mapLegend' || name === 'mapHover') {
