...
def main():
    ...
    if not all_laps and not lap_json_files and not session_parquet_files:
        ...
        session_parquet_files = [
            Path('dev/sessions/session_20260510T124244Z_circuit-de-barcelona_lmu.parquet'),
            Path('dev/sessions/session_20260511T151203Z_circuit-de-barcelona_lmu.parquet'),
            Path('dev/sessions/session_20260514T141305Z_circuit-de-barcelona_lmu.parquet'),
        ]
